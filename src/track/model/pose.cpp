...
std::vector<float> Pose::GetOutputPose() const{

	cinder::Matrix44<float> temp = rotation_.toMatrix44();
	std::vector<float> ret;
	ret.push_back(temp.m00);
	ret.push_back(temp.m01);
	ret.push_back(temp.m02);
	ret.push_back(translation_[0]);
	ret.push_back(temp.m10);
	ret.push_back(temp.m11);
	ret.push_back(temp.m12);
	ret.push_back(translation_[1]);
	ret.push_back(temp.m20);
	ret.push_back(temp.m21);
	ret.push_back(temp.m22);
	ret.push_back(translation_[2]);
	return ret;
}
